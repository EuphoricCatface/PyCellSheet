...
try:
    from pycellsheet.__init__ import APP_NAME, VERSION
    from pycellsheet.installer import REQUIRED_DEPENDENCIES
except ImportError:
...
class PyCellSheetArgumentParser(ArgumentParser):
    ...
    def __init__(self):
        ...
        description = "PyCellSheet is a non-traditional spreadsheet that is " \
        ...
        self.add_argument('file', type=Path, nargs='?', default=None,
                          help='open PyCellSheet file in pys or pysu format')
