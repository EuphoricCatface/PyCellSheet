...
try:
    from pycellsheet.settings import (ICON_PATH, ACTION_PATH, STATUS_PATH,
                                      CHARTS_PATH)
except ImportError:
...
class IconPath:
    ...
    pycellsheet = ICON_PATH / 'hicolor' / 'svg' / 'pyspread.svg'
    # Compatibility alias for pre-rename call sites.
    pyspread = pycellsheet
