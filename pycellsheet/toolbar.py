...
try:
    from pycellsheet.actions import MainWindowActions, ChartDialogActions
    from pycellsheet.icons import Icon
    from pycellsheet.menus import ToolbarManagerMenu
    from pycellsheet.widgets import FindEditor
except ImportError:
...
class MacroToolbar(ToolBarBase):
    """The macro toolbar for pycellsheet"""
...
class FindToolbar(ToolBarBase):
    """The find toolbar for pycellsheet"""
...
class FormatToolbar(ToolBarBase):
    """The format toolbar for pycellsheet"""
