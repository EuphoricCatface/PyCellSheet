...
try:
    ...
    from pycellsheet.dialogs import DiscardDataDialog
    from pycellsheet.grid_renderer import (painter_save, CellRenderer,
                                           CellEdgeRenderer,
    ...
    from pycellsheet.lib.string_helpers import quote, wrap_text
    from pycellsheet.lib.sheet_name import validate_sheet_name
    from pycellsheet.lib.qimage2ndarray import array2qimage
    from pycellsheet.lib.typechecks import is_svg, check_shape_validity
    from pycellsheet.menus import (GridContextMenu, TableChoiceContextMenu,
                                   HorizontalHeaderContextMenu,
                                   VerticalHeaderContextMenu)
    from pycellsheet.widgets import CellButton
    from pycellsheet.lib.pycellsheet import EmptyCell, HelpText, RangeOutput, Formatter
except ImportError:
    import commands
