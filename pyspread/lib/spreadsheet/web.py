...
def ENCODEURL(a, b):
    raise NotImplementedError("ENCODEURL() not implemented yet")


def HYPERLINK(a, b):
    raise NotImplementedError("HYPERLINK() not implemented yet")
...
def ISURL(a, b):
    raise NotImplementedError("ISURL() not implemented yet")